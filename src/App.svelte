...
<h1 class="text-5xl text-center">
  Добро пожаловать в <strong>Security Chat<strong>
</h1>

<i class="bi bi-github text-white text-[150px] text-center"></i>

<div class="text-center px-3">
  <h2><strong>Security Chat</strong> используется в качестве аутификации специальный файл. Если вы его утратили, то <strong>восстановление данные невозможно</h2>
